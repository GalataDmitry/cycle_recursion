...
function App() {
    ...
    const [startPosition, setStartPosition] = useState<StartPositionTypes>({
        x: null,
        y: null,
        change: true
    })
    const [startSize, setStartSize] = useState<StartSizeTypes>({
        width: null,
        height: null,
        change: true
    })
        ...
        <>
            ...
            <button
                onClick={() => {
                    const elem = document.getElementById('draggable')
                    if (
                        typeof startSize.width === 'string' &&
                        typeof startSize.height === 'string'
                    ) {
            ...
            <div
                ...
                <div
                    ...
                    <div className='main_node_wrapper'>
                        <div className='main_node'>ROOT</div>
                        <button
                            onClick={() =>
                                setSubElements([
                                    ...subElements,
